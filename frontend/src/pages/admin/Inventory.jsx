            ...
            <div className="flex flex-1 overflow-hidden relative">
                ...
                <main className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-10">
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8 md:mb-12">
                        <div>
                            <h1 className="text-xl md:text-3xl font-black text-gray-900 mb-1 tracking-tight">Inventory Management</h1>
                            <p className="text-xs md:text-sm text-gray-500 font-medium">Add, track and manage your refurbished laptop stock.</p>
                        </div>
                        <button
                            onClick={() => {
                                resetForm();
                            ...
                            className="flex items-center justify-center gap-2 px-6 py-3.5 bg-blue-600 text-white rounded-2xl font-black hover:bg-blue-700 transition-all shadow-xl shadow-blue-100 active:scale-95 text-xs uppercase tracking-widest"
                        >
