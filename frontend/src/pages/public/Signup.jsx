...
const Signup = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        console.log('Updating backend with:', formData);
        setError('');
    ...
    return (
        <div className="min-h-screen bg-[#f8fafc] flex items-center justify-center p-4 selection:bg-blue-100 py-12">
            {/* Background blobs for aesthetics */}
            <div className="fixed inset-0 overflow-hidden pointer-events-none">
                <div className="absolute top-[-10%] right-[-5%] w-[40%] h-[40%] bg-blue-100 rounded-full blur-3xl opacity-50 animate-pulse"></div>
                <div className="absolute bottom-[-10%] left-[-5%] w-[40%] h-[40%] bg-indigo-100 rounded-full blur-3xl opacity-50 [animation-delay:2s] animate-pulse"></div>
            </div>

            <div className="w-full max-w-xl relative">
                {/* Logo/Brand */}
                <div className="text-center mb-8 animate-in fade-in-up duration-700">
                    <p className="text-[10px] text-gray-300 mb-2">Build v1.1.0-auth</p>
                    <Link to="/" className="inline-flex items-center mb-8">
                        <img src="/img/logo.png" alt="Vagwiin Logo" className="h-16 w-auto object-contain transition-all" />
                    </Link>
                    <h1 className="text-2xl font-bold text-gray-900">Create Account</h1>
                    <p className="text-gray-500 mt-2">Join us today and experience the difference</p>
                </div>
                ...
                <div className="bg-white/80 backdrop-blur-xl p-8 rounded-3xl shadow-xl shadow-blue-500/5 border border-white/20 animate-in fade-in zoom-in duration-500">
                    ...
                    <div className="my-8 flex items-center gap-4 text-gray-400">
                        ...
                        <span className="text-xs font-medium uppercase tracking-wider">Or register with</span>
                        <div className="h-[1px] flex-1 bg-gray-100"></div>
                    </div>
                ...
                <p className="text-center mt-8 text-gray-600 transition-all">
